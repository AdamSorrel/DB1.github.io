...
> [!WARNING]
> It is your group responsibility to ensure that you are all up to speed. In the case of extreme misunderstanding regarding this, you can always talk to your TAs and the teacher. 
...
- The smaller windows on the right shows the file system of the folder you are working with. You can change this folder by going to `File - Open folder`. 
  - > [!WARNING]
    >You should be working only in the folder `db1` created by the provided isntallation script. 
...
> [!WARNING]
> **Start by connecting the HUZZAH32 to the computer you are working with. Use the provided USB cable.**
...
> [!TIP] 
> Remember this option, you will use it practically every time when connecting to the device during our exercises.
...
> [!TIP]
> This preview of files on the device through `serial:COM18` might not work very well. It often does not get updated very regularly so even if you upload files, they might not show up there. I would recommend largely ignoring it. 
> 
